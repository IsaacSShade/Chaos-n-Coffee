...
local ChamomileTea = game.ServerStorage["Uncapped Chamomil-e Tea"]
...
script.Parent.Touched:connect(function(hit)
	if hit.Parent:FindFirstChild("Humanoid") then
		...
		if plr:FindFirstChild("Cup with Hot Water") == nil then
			...
			HotWater:Destroy()
			local cup2 = ChamomileTea:Clone()
			cup2.Parent = player.Backpack
			plr.Humanoid:EquipTool(cup2.Parent:FindFirstChild("Uncapped Chamomil-e Tea"))
		end
	end
end)
